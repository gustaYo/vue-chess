...
<md-navbar title="Logo" right
           hamburger mode="hide-on-med-and-down"
           wrapper-class="container" nav-class="light-blue lighten-1">
    <md-nav-item href="#">
        Navbar Link
    </md-nav-item>
</md-navbar>
...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        ...
        <div class="row center">
            <md-button href="#" large
               class="waves-effect waves-light orange">
                Get Started
            </md-button>
        </div>
        <br><br>
...
<script src="dist/vue-material-components.min.js"></script>
<script>
